...
- elementary integer arithmetic and parity / modular reasoning;
- (finite / well-ordered) induction and finite descent over the integers;
- unfolding the recursion a finite, explicitly bounded number of times;
- size / bounding (inequality) arguments;
- listed methods in `knowledge/methods/`.

No special per-problem external citable is required for this problem.
