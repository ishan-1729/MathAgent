...
The `papers/` folder can be used to brainstorm workflow designs and coherent software configurations. For example, a workflow may combine a planner/prover split, Lean feedback, retrieval, self-correction, or evolutionary search if the configuration is described explicitly.
